    ...
    <div class="card has-table">
      ...
      <div class="card-content">
        <table>
          ...
          <tbody>
                   <%
            List<Issue> ls=new IssueDao().retrieveData();
            for(Issue issue:ls)
            {
            %>
              <tr>
                ...
                <td><%=issue.getUsername() %></td>
                  ...
                  <div class="buttons right nowrap">
                    <a class="button small green --jb-modal" href="updateticketadmin.jsp?iid=<%=issue.getRid()%>"><span class="icon">
                    <i class="mdi mdi-eye"></i>
                    </span></a>
                      
                   
                    <a class="button small red --jb-modal" href="deleteissueserv?id=<%=issue.getRid() %>">
