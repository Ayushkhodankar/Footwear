    ...
    <section class="section main-section">
      <div class="card mb-6">
        ...
        <div class="card-content">
          <form method="post" action="addcategoryserv">
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  ...
                  <div class="control icons-left">
                    <input class="input" type="text" placeholder="Enter Name Of Category" name="cname">
            ...
            <div class="field">
              ...
              <div class="control">
                <textarea class="textarea" placeholder="Enter Description About The Category" name="cdesc"></textarea>
              </div>
            </div>
            <hr>
